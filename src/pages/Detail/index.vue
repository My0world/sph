      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          <div class="goodsDetail">
            ...
            <p v-if="skuInfo.skuDesc" class="news">
              {{ skuInfo.skuDesc }}
            </p>
            <div class="priceArea">
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <input
                  ...
                  oninput="value=parseInt(value.replace(/^(0+)|[^\d]+/g,''))"
                />
                <button href="javascript:" class="plus" @click="skuNum++">
                  +
                </button>
                <button
                  href="javascript:"
  ...
  methods: {
    ...
    async addShopCar() {
      ...
      /*
        ...
        上面这行代码：调用仓库中的addOrUpdateShopCart
      */
      try {
        ...
        // 产品信息的数据【比较复杂：skuInfo】,通话会话存储（不持久化，会话结束数据会消失）
        // 本地存储|会话存储，一般存储的是字符串
        this.$router.push({
          path: "/addCartSuccess",
          query: {
